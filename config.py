...
#
# ssrshare.us所有功能完整可用(暂时还没发现不能用的功能),
# 由于ssrshare.us官方的设定, 网页版是无法上传文件的, 只能看别人的动态
#
# Github: https://github.com/Aploium/zmirror

# ############## Local Domain Settings ##############
##my_host_name = '127.0.0.1'
my_host_name = 'ssrr.tonycn.cf'
my_host_scheme = 'http://'
my_host_port = None  # None表示使用默认端口, 可以设置成非标准端口, 比如 81

# ############## Target Domain Settings ##############
target_domain = 'www.ssrshare.com'
target_scheme = 'https://'
...
external_domains = (
    ...
    'tools.ssrshare.com',
    'down.ssrshare.com',
    'telegram.ssrshare.com',
    'go.ssrshare.com',
    
    'www.ssrshare.us',
    'tools.ssrshare.us',
    'down.ssrshare.us',
    'telegram.ssrshare.us',
    'go.ssrshare.us',
    
    'www.ssrtool.com',
    'tools.ssrtool.com',
    'down.ssrtool.com',
    'telegram.ssrtool.com',
    'go.ssrtool.com',
    'status.ssrtool.com',
    'www.ssrcap.com',
    'www.stool.cf',
...
domains_whitelist_auto_add_glob_list = (
    '*.ssrshare.com', '*.ssrshare.us', '*.ssrtool.com', '*.ssrtool.us', '*.ssrcap.com', '*.stool.cf')
